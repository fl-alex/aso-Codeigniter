...
//                                data-short_name="'+data[i].short_name+'">Browse</a>'+' '+
                        '<a href="javascript:void(0);" class="btn btn-warning btn-sm item_edit" \n\
                                ...
                                data-fam="'+data[i].fam+'" \n\
                                data-name="'+data[i].name+'" \n\
                                data-father="'+data[i].father+'"\n\
                                data-dateborn="'+data[i].dateborn+'"\n\
                                data-num_doc="'+data[i].num_doc+'"\n\
                                data-id_classiness="'+data[i].id_classiness+'"\n\
                                data-club="'+data[i].club+'">Edit</a>'+' '+
...
//=============================================================================
    ...
    function myfunc(){       
        document.getElementById("enter_list").innerHTML += document.getElementById("enter_code").value + "<br>";               
    }
