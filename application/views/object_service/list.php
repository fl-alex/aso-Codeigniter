...
//-------------- запрос на удаление и обновление отображения данных
 ...
 // ======================== Удаление на форме дочернего объекта ===============    
    ...
    $('body').on('click','.btn_child', function(){        
        ...
        get_interface_settings ('get_parts_by_service_id', '#modal_rel_object #mysubtable', $(this).data('id'));                        
        ...
        get_interface_settings ('form_edit_service_parts', '#modal_rel_object #form_edit');        
    });
  ...
  function refresh_subtable(){
      $('#mysubtable').empty();//контейнер для таблицы      
      get_interface_settings ('get_parts_by_service_id', '#modal_rel_object #mysubtable', $('#'+$('#modal_rel_object form').attr('id')+'_'+'id_parent').val());
  }
