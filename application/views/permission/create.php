                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Довідники</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createSpr" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateSpr" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewSpr" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteSpr" class="minimal"></td>
                      </tr>
